 ...
 */
public class Pengu2 extends Mover2
{
    // "physics" variables
...
//             m.increaseLevel();
    ...
    public boolean onGround2()
    {
        ...
        {
            under = (Surface2)getOneObjectAtOffset ( 0, getImage().getHeight() / 2 + counter, Surface2.class);
            counter++;
        }
     ...
     */
    public Actor getSurface2()
    {
        Actor under = getOneObjectAtOffset ( 0, getImage().getHeight() / 2, Surface2.class);
        int counter = -1;
        int max = vSpeed + 2;
        while (counter <= max && under == null)
        {
            under = getOneObjectAtOffset ( 0, getImage().getHeight() / 2 + counter, Surface2.class);
            counter++;
        }
        return under;
    }
    ...
    public Enemy2 getEnemy2()
    {
        ...
        {
            Actor temp = getOneIntersectingObject(Enemy2.class);
            Enemy2 enemy2 = (Enemy2)temp;
            currCollDetection = 0;
            return enemy2;
        }
        else
